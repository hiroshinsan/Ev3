...
import Input from '@ev3/ui/dist/tailwind/Input';
import Textarea from '@ev3/ui/dist/tailwind/Textarea';
import Number from '@ev3/ui/dist/tailwind/Number';
import Password from '@ev3/ui/dist/tailwind/Password';
import InputMask from '@ev3/ui/dist/tailwind/InputMask';

import Checkbox from '@ev3/ui/dist/tailwind/Checkbox';
import Radio from '@ev3/ui/dist/tailwind/Radio';
import Switch from '@ev3/ui/dist/tailwind/Switch';

import Select from '@ev3/ui/dist/tailwind/Select';
import SelectCountry from '@ev3/ui/dist/tailwind/SelectCountry';
import SelectCurrency from '@ev3/ui/dist/tailwind/SelectCurrency';

import Autocomplete from '@ev3/ui/dist/tailwind/Autocomplete';

import { Date as DateField, Time, Datetime } from '@ev3/ui/dist/tailwind/Date';

import Textlist from '@ev3/ui/dist/tailwind/Textlist';
import Metadata from '@ev3/ui/dist/tailwind/Metadata';
  ...
  return (
    <div className="p-4">
      ...
      <Control label="Number 1" className="mt-2">
        <Number defaultValue={1900.01} onUpdate={console.log} />
      </Control>
      <Control label="Number 2" error="something" className="mt-2">
        <Number defaultValue="1900.01" min="0" max="2000" onUpdate={console.log} />
      </Control>
      ...
      <Control label="Date 1">
        ...
        <Time defaultValue={Date.now()} onUpdate={console.log} className="my-2" />
      ...
      <Control label="Date 2" error="something" className="mt-2">
        ...
        <Time defaultValue={Date.now()} onUpdate={console.log} className="my-2" error={true} />
